...
jnd_field_goby<-read.csv("data/static_camouflage/jnd_field_goby.csv",header=T)
jnd_field_pollack<-read.csv("data/static_camouflage/jnd_field_pollack.csv",header=T)
